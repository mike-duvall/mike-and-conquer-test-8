...
class Util {
    ...
    static Point convertMapSquareCoordinatesToWorldCoordinates(int x, int y) {
    ...
    static Point convertWorldCoordinatesToMapSquareCoordinates(int x, int y) {
        ...
        int mapSquareX = x / mapSquareWidth;
        int mapSquareY = y / mapSquareWidth;

        return new Point(mapSquareX, mapSquareY)
    }
